          ...
          <div className="mb-8">
            <div className="flex items-center justify-between">
              ...
              <div className="text-center">
                ...
                <div className="text-xs text-theme-tertiary mt-1">Selected: {selectedMonthKey}</div>
              </div>
              ...
              {months.map((m, idx) => {
                ...
                return (
                  ...
                  >
                    ...
                    <div className="text-xs text-theme-tertiary">{currentYear}</div>
                  </button>
                )
              })}
            </div>
        ...
        <div className="bg-gradient-to-br from-gray-800 to-gray-900 border border-yellow-500/30 rounded-2xl overflow-hidden shadow-lg shadow-yellow-500/10">
          <div className="bg-gradient-to-r from-emerald-500 to-emerald-600 p-6">
            <div className="flex items-center justify-between">
              <div className="flex items-center space-x-3">
                ...
                <h3 className="text-xl font-bold text-theme-primary">Monthly Objectives</h3>
              </div>
          ...
          {state.plans.length === 0 ? (
            <div className="p-8 text-center">
              ...
              <p className="text-theme-tertiary mb-6">Create your first monthly objective to get started</p>
              <button
                onClick={() => router.push(`/create?type=monthly&month=${encodeURIComponent(selectedMonthKey)}`)}
                className="px-6 py-3 bg-gradient-to-r from-emerald-500 to-emerald-600 hover:from-emerald-600 hover:to-emerald-700 text-theme-primary rounded-xl font-semibold shadow-lg hover:shadow-xl transition-all duration-200 transform hover:-translate-y-0.5 border border-emerald-400/50"
              >
                Create Monthly Plan
              </button>
            </div>
