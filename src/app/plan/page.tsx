          ...
          <div className="bg-white rounded-xl border border-gray-200 p-6 shadow-sm">
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <p className="text-2xl font-bold text-gray-900">{state.totalTasks}</p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white rounded-xl border border-gray-200 p-6 shadow-sm">
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <p className="text-2xl font-bold text-gray-900">{state.completedTasks}</p>
              </div>
            </div>
          </div>
        ...
        <div className="bg-white rounded-xl border border-gray-200 overflow-hidden shadow-sm">
          <div className="bg-blue-500 p-6">
            <div className="flex items-center justify-between">
              <div className="flex items-center space-x-3">
                ...
                <h3 className="text-xl font-semibold text-white">{selectedMonth} Plans</h3>
              </div>
              <div className="flex items-center space-x-4">
          ...
          {state.plans.length === 0 ? (
            <div className="p-8 text-center">
              ...
              <p className="text-gray-500 mb-6">Create new plans to get started</p>
              <button
                onClick={() => router.push('/create?type=monthly')}
                  ...
                  <div className="flex items-start space-x-6">
                    <div className="flex-shrink-0">
                      <select
                        ...
                        className="px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 text-gray-900 font-medium text-sm cursor-pointer"
                      >
