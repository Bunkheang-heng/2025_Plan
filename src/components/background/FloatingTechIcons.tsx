...
export default function FloatingTechIcons({ count = 6 }: FloatingTechIconsProps) {
  return (
    <div className="absolute inset-0">
      {[...Array(count)].map((_, i) => (
        <div
          key={i}
          className="absolute opacity-5 text-emerald-600 animate-bounce"
          style={{
        ...
        >
          ...
          {i % 6 === 2 && (
            <svg className="w-7 h-7 animate-ping" fill="none" stroke="currentColor" viewBox="0 0 24 24">
