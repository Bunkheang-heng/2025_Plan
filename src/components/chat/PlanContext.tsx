        ...
        {isVisible && (
          <div className="mt-6 space-y-6">
            ...
            <div className="grid grid-cols-3 gap-4">
              ...
              <Card variant="default" padding="sm">
                <div className="text-center">
                  <div className="text-2xl font-bold text-green-600">{stats.monthly.completed}/{stats.monthly.total}</div>
                  <div className="text-sm text-stone-600">Monthly</div>
                </div>
              </Card>
            </div>
            ...
            {plans.length > 0 && (
              <div>
                <h4 className="text-sm font-semibold text-stone-700 mb-3">Recent Plans ({plans.length})</h4>
                <div className="space-y-2 max-h-48 overflow-y-auto">
                  {plans.slice(0, 10).map((plan) => (
                    <div key={plan.id} className="flex items-center justify-between p-3 bg-stone-50 rounded-lg">
                      <div className="flex-1">
                        <div className="flex items-center space-x-2 mb-1">
                          ...
                          <span className="font-medium text-stone-900 text-sm">{plan.title}</span>
                        </div>
