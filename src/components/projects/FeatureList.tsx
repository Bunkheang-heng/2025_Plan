...
export default function FeatureList({
  ...
  return (
    <div className="pt-4 border-t border-theme-secondary">
      ...
      {isAddingFeature && (
        <div className="mb-4 p-4 bg-theme-tertiary/30 border border-yellow-500/20 rounded-xl">
          <div className="space-y-3">
            <input
              ...
              className="w-full px-3 py-2 bg-theme-secondary border border-yellow-500/30 rounded-lg text-theme-primary text-sm focus:outline-none focus:ring-2 focus:ring-yellow-500/50 focus:border-yellow-500"
            />
            <textarea
              ...
              rows={2}
              className="w-full px-3 py-2 bg-theme-secondary border border-yellow-500/30 rounded-lg text-theme-primary text-sm focus:outline-none focus:ring-2 focus:ring-yellow-500/50 focus:border-yellow-500 resize-none"
            />
            <div className="flex items-center space-x-3">
              ...
              <select
                ...
                className="px-3 py-1.5 bg-theme-secondary border border-yellow-500/30 rounded-lg text-theme-primary text-xs focus:outline-none focus:ring-2 focus:ring-yellow-500/50 focus:border-yellow-500"
              >
