  ...
  return (
    <div className="pt-4 border-t border-theme-secondary">
      <div className="flex items-center justify-between mb-4">
        <label className="flex items-center space-x-2 text-sm font-bold text-blue-600">
        ...
        <button
          ...
          className="px-3 py-1.5 bg-blue-500/20 hover:bg-blue-500/30 text-blue-600 text-xs font-semibold rounded-lg border border-blue-500/30 transition-colors"
        >
      ...
      {isAddingFeature && (
        <div className="mb-4 p-4 bg-theme-tertiary/30 border border-blue-500/20 rounded-xl">
          <div className="space-y-3">
            <input
              ...
              className="w-full px-3 py-2 bg-theme-secondary border border-blue-500/30 rounded-lg text-theme-primary text-sm focus:outline-none focus:ring-2 focus:ring-blue-500/50 focus:border-blue-500"
            />
            <textarea
              ...
              rows={2}
              className="w-full px-3 py-2 bg-theme-secondary border border-blue-500/30 rounded-lg text-theme-primary text-sm focus:outline-none focus:ring-2 focus:ring-blue-500/50 focus:border-blue-500 resize-none"
            />
            <div className="flex items-center space-x-3">
              ...
              <select
                ...
                className="px-3 py-1.5 bg-theme-secondary border border-blue-500/30 rounded-lg text-theme-primary text-xs focus:outline-none focus:ring-2 focus:ring-blue-500/50 focus:border-blue-500"
              >
              ...
              <button
                ...
                className="px-4 py-1.5 bg-blue-500 hover:bg-blue-600 text-stone-900 text-xs font-semibold rounded-lg transition-colors"
              >
                Add
              </button>
            </div>
