  ...
  return (
    <div className="pt-4 border-t border-stone-200">
      <div className="flex items-center justify-between mb-4">
        <label className="flex items-center space-x-2 text-sm font-bold text-emerald-600">
        ...
        <button
          ...
          className="px-3 py-1.5 bg-emerald-500/20 hover:bg-emerald-500/30 text-emerald-600 text-xs font-semibold rounded-lg border border-emerald-500/30 transition-colors"
        >
        ...
        <div className="mb-4 p-4 bg-stone-50 border border-stone-200 rounded-xl">
          <div className="space-y-3">
            <input
              ...
              className="w-full px-3 py-2 bg-white border border-stone-200 rounded-lg text-stone-800 text-sm focus:outline-none focus:ring-2 focus:ring-emerald-500/50 focus:border-emerald-500"
            />
            <textarea
              ...
              rows={2}
              className="w-full px-3 py-2 bg-white border border-stone-200 rounded-lg text-stone-800 text-sm focus:outline-none focus:ring-2 focus:ring-emerald-500/50 focus:border-emerald-500 resize-none"
            />
            <div className="flex items-center space-x-3">
              ...
              <select
                ...
                className="px-3 py-1.5 bg-white border border-stone-200 rounded-lg text-stone-800 text-xs focus:outline-none focus:ring-2 focus:ring-emerald-500/50 focus:border-emerald-500"
              >
