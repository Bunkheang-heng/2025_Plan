...
export default function ProjectCard({
  ...
  return (
    <div
      ...
      className={`bg-theme-card border border-blue-500/30 rounded-2xl overflow-hidden shadow-lg shadow-blue-500/10 hover:shadow-blue-500/20 transition-all duration-300 ${
        ...
        <div className="flex items-start justify-between mb-4">
          <div className="flex items-center space-x-3">
            <div className={`p-2 rounded-lg ${
              project.type === 'website' ? 'bg-blue-500/20 text-blue-600' :
              project.type === 'mobile' ? 'bg-blue-500/20 text-blue-600' :
        ...
        {project.features && project.features.length > 0 && (
          <div className="mb-4 pt-4 border-t border-theme-secondary">
            <div className="flex items-center justify-between mb-2">
              <span className="text-xs font-bold text-blue-600">Features</span>
          ...
          <div className="mt-4 pt-4 border-t border-theme-secondary flex items-center space-x-4">
            {project.repositoryUrl && (
              <a
                ...
                className="flex items-center space-x-1 text-blue-600 hover:text-blue-600 text-xs"
              >
