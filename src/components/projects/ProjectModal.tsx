...
export default function ProjectModal({
  ...
  return (
    <div className="fixed inset-0 bg-black/80 backdrop-blur-sm flex items-center justify-center p-4 z-50 animate-fade-in overflow-y-auto">
      <div className="bg-theme-card border-2 border-blue-500/30 rounded-2xl max-w-2xl w-full shadow-2xl shadow-blue-500/20 animate-slide-up my-8">
        ...
        <form onSubmit={onSubmit} className="p-6 space-y-6 max-h-[70vh] overflow-y-auto">
          <div>
            ...
            <input
              ...
              className="w-full px-4 py-3 bg-theme-secondary border-2 border-blue-500/30 rounded-xl text-theme-primary text-sm focus:outline-none focus:ring-2 focus:ring-blue-500/50 focus:border-blue-500"
            />
          </div>
