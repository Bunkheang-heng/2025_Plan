...
export default function ProjectModal({
  ...
  return (
    <div className="fixed inset-0 bg-black/80 backdrop-blur-sm flex items-center justify-center p-4 z-50 animate-fade-in overflow-y-auto">
      <div className="bg-white border-2 border-stone-200 rounded-2xl max-w-2xl w-full  animate-slide-up my-8">
        ...
        <form onSubmit={onSubmit} className="p-6 space-y-6 max-h-[70vh] overflow-y-auto">
          <div>
            ...
            <input
              ...
              className="w-full px-4 py-3 bg-stone-100 border-2 border-stone-200 rounded-xl text-stone-900 text-sm focus:outline-none focus:ring-2 focus:ring-emerald-500/50 focus:border-emerald-500"
            />
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              ...
              >
                ...
                <option value="mobile" className="bg-stone-100 text-stone-900">Mobile App</option>
          ...
          <div>
            ...
            <textarea
              ...
              rows={4}
              className="w-full px-4 py-3 bg-stone-100 border-2 border-stone-200 rounded-xl text-stone-900 text-sm focus:outline-none focus:ring-2 focus:ring-emerald-500/50 focus:border-emerald-500 resize-none"
            />
          </div>
          ...
          <div>
            ...
            <input
              ...
              className="w-full px-4 py-3 bg-stone-100 border-2 border-stone-200 rounded-xl text-stone-900 text-sm focus:outline-none focus:ring-2 focus:ring-emerald-500/50 focus:border-emerald-500"
            />
            <p className="text-xs text-stone-400 mt-2">Separate technologies with commas</p>
          </div>
          ...
          <div className="flex space-x-4 pt-4">
            <button
              type="submit"
              className="flex-1 px-6 py-4 bg-emerald-600 text-white font-bold rounded-xl hover:bg-emerald-700 transition-all duration-300  hover:shadow-stone-200 text-lg"
            >
            ...
            <button
              type="button"
              onClick={onClose}
              className="px-6 py-4 bg-stone-200 hover:bg-stone-100 text-stone-900 font-bold rounded-xl transition-colors"
            >
              Cancel
            </button>
          </div>
